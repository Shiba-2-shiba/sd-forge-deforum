...
class TransformerManager:
    ...
    def _load_virtual_transformer(self):
        ...
        with init_empty_weights():
            config_path = "/root/.cache/huggingface/hub/models--hunyuanvideo-community--HunyuanVideo/snapshots/e8c2aaa66fe3742a32c11a6766aecbf07c56e773/transformer"
            config = HunyuanVideoTransformer3DModelPacked.load_config(config_path, local_files_only=True)
